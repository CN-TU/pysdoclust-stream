#ifndef SDOCLUSTREAM_FIT_H
#define SDOCLUSTREAM_FIT_H

template<typename FloatType> 
void SDOclustream<FloatType>::fit_impl(
...
template<typename FloatType>
void SDOclustream<FloatType>::fit_point(
        std::unordered_map<int, std::pair<FloatType, FloatType>>& temporary_scores,
        const Point& point,
        FloatType now,           
...
template<typename FloatType>
void SDOclustream<FloatType>::update_model(
