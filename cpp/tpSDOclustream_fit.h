#ifndef TPSDOCLUSTREAM_FIT_H
#define TPSDOCLUSTREAM_FIT_H

template<typename FloatType> 
void tpSDOclustream<FloatType>::fit_impl(
...
template<typename FloatType>
void tpSDOclustream<FloatType>::fit_point(
        std::unordered_map<int, std::pair<std::vector<std::complex<FloatType>>, FloatType>>& temporary_scores,
        const Point& point,
        FloatType now,           
...
template<typename FloatType>
void tpSDOclustream<FloatType>::update_model(
